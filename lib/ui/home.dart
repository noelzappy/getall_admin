...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({required this.waits});
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _load() async {
    // var ret = await _mainModel.booking.load();
    // if (ret != null)
  ...
  _getList() {
    ...
    list.add(Container(
      height: windowHeight*0.8,
        child: EarningScreen(waits: widget.waits,)));
      ...
      child: SfCartesianChart(
          ...
          series: <ChartSeries<EarningData, String>>[
            LineSeries<EarningData, String>(
                ...
                xValueMapper: (EarningData sales, _) => sales.year,
                yValueMapper: (EarningData sales, _) => sales.sales,
  ...
  _category(){
    return Expanded(child: Button186(text1: strings.get(158).toUpperCase(), /// "CATEGORY"
      style1: theme.style18W800Grey,
      text2: "${appSettings.categoryCount}", style2: theme.style16W800Black,
