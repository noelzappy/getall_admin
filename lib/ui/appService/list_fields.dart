...
class _ListFieldsState extends State<ListFields> {
  ...
  _getList(){
      ...
      if (item.typeData == "selectImage"){
        list.add(Row(
          children: [
            ...
            Expanded(child: button2small(strings.get(75), (){_selectImage(item);})) /// "Select image",
          ],
        ));
      }
    ...
    if (_mainModel.serviceApp.select.fields.isNotEmpty)
      list.add(Row(
        children: [
          button2small(strings.get(9), _saveAll), /// "Save",
        ],
      ));
    ...
    if (_mainModel.serviceApp.select.strings.isNotEmpty){
      ...
      list.add(Row(
        children: [
          button2small(strings.get(212), _save), /// "Save words",
        ],
      ));
    }
    return list;
