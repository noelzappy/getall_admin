...
class LoginScreen extends StatefulWidget {
  ...
  const LoginScreen(
      {Key? key, required this.windowWidth, required this.windowHeight})
      : super(key: key);
  @override
            ...
            child: Stack(
              children: <Widget>[
                ...
                ClipPath(
                    ...
                    child: Container(
                      color: (darkMode)
                          ? serviceApp.blackColorTitleBkg
                          : serviceApp.colorBackground,
                      width: windowWidth,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: (serviceApp.loginLogoAsset)
                                ? Image.asset("assets/ondemands/ondemand1.png",
                                    fit: BoxFit.cover)
                                : Image.network(serviceApp.loginLogo,
                                    fit: BoxFit.cover),
                          ),
                          SizedBox(
                            height: 20,
                          ),
                          Text(strings.get(0), // "GETALL",
                              style: theme.style16W800),
                          SizedBox(
                            height: 5,
                          ),
                          ...
                          Expanded(
                              child: Container(
                                  ...
                                  child: (serviceApp.loginImageAsset)
                                      ? Image.asset(
                                          "assets/ondemands/ondemand2.png",
                                          fit: BoxFit.cover)
                                      : Image.network(serviceApp.loginImage,
                                          fit: BoxFit.cover)))
                        ],
                      ),
                    )),
