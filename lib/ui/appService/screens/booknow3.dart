...
class BookNow3Screen extends StatefulWidget {
  ...
  const BookNow3Screen({Key? key, required this.windowWidth, required this.windowHeight}) : super(key: key);
  ...
  _body(){
    ...
    list.add(Container(
      ...
      child: checkBox43(strings.get(81), // "Cash payment",
          serviceApp.booking4CheckBoxColor, "assets/cache.png",
          theme.style14W800,
          true, (val) {
            // if (val) {
    ...
    // if (Provider.of<MainModel>(context,listen:false).localAppSettings.stripeEnable)
      list.add(Container(
        ...
        child: checkBox43("Stripe",
            serviceApp.booking4CheckBoxColor, "assets/stripe.png",
            theme.style14W800,
            false, (val) {
              // if (val) {
    ...
    // if (Provider.of<MainModel>(context,listen:false).localAppSettings.razorpayEnable)
      list.add(Container(
          ...
          child: checkBox43("Razorpay", serviceApp.booking4CheckBoxColor, "assets/razorpay.png",
              theme.style14W800,
              false, (val) {
                // if (val) {
    ...
    // if (Provider.of<MainModel>(context,listen:false).localAppSettings.paypalEnable)
      list.add(Container(
          ...
          child: checkBox43("Pay Pal", serviceApp.booking4CheckBoxColor, "assets/paypal.png",
              theme.style14W800,
                false, (val) {
                // if (val) {
