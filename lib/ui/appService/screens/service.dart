...
class _ServicesScreenState extends State<ServicesScreen> {
    ...
    return Stack(
        children: [
          ...
          (darkMode) ? Colors.black : Colors.white,
              ...
              (_scroller > 5) ? "" : getTextByLocale(_mainModel.service.current.name, _mainModel.currentEmulatorLanguage), context, () {}),
  ...
  _title() {
    var _data = Provider.of<MainModel>(context,listen:false).service.getTitleImage();
    return Container(
  ...
  _body(){
    ...
    list.add(
      Column(
        children: [
          Text(getTextByLocale(_mainModel.service.current.name, _mainModel.currentEmulatorLanguage),
    ...
    if (_mainModel.service.current.price.isNotEmpty) {
      list.add(Divider(color: Colors.grey.withAlpha(100)));
      list.add(SizedBox(height: 20,));
    }

    if (_mainModel.service.current.descTitle.isNotEmpty){
      list.add(Container(
          ...
          child: Column(
            ...
            children: [
              Text(getTextByLocale(_mainModel.service.current.descTitle, _mainModel.currentEmulatorLanguage),
                style: theme.style16W800, textAlign: TextAlign.start,),   /// "Description",
              Divider(color: (darkMode) ? Colors.white : Colors.black),
              SizedBox(height: 5,),
              Text(getTextByLocale(_mainModel.service.current.desc, _mainModel.currentEmulatorLanguage), style: theme.style14W400),
              SizedBox(height: 5,),
              Divider(color: (darkMode) ? Colors.white : Colors.black),
            ],
          )
    ...
    list.add(Container(
      ...
      children: [
        ...
        Text("${_mainModel.service.current.duration.inMinutes} ${strings.get(98)}", style: theme.style16W800,) /// min
      ],
    ),));
