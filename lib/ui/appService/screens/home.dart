      ...
      list.add(Hero(
          ...
          child: Container(
              ...
              child: button202(getTextByLocale(item.name, _mainModel.currentEmulatorLanguage), theme.style16W800,
                ...
                item.gallery.isNotEmpty ? item.gallery[0].serverPath : "", windowWidth-20, windowSize/2-20, 20, (){
