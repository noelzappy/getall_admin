...
class _CategoryScreenState extends State<CategoryScreen> {
                ...
                return [
                  SliverAppBar(
                      ...
                      flexibleSpace: ClipPath(
                        ...
                        child: Container(
                            color: _mainModel.category.current.color,
                            child: Stack(
                              children: [
                                FlexibleSpaceBar(
        ...
        children: [
          ...
          Container(
                ...
                child: Container(
                  ...
                  child: _mainModel.category.current.serverPath.isNotEmpty ? Image.network(
                    _mainModel.category.current.serverPath,
                      fit: BoxFit.contain,
                  ) : Container(),
  ...
  _body(){
    ...
    var count = 0;
    for (var item in context.read<MainModel>().service.services) {
