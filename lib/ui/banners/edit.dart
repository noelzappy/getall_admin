...
class _EditInBannerState extends State<EditInBanner> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_mainModel.banner.current.id.isEmpty)
      list.add(button2small(strings.get(333), () async {        /// "Create new banner",
      ...
      list.add(Row(
        children: [
          Expanded(child: button2small(strings.get(334), () async { /// "Save current banner",
          ...
          button2small(strings.get(335), (){                 /// "Add New banner",
