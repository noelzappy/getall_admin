...
class _DialogViewProviderRequestInfoState extends State<DialogViewProviderRequestInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in _mainModel.currentProviderRequest.providerCategory){
      if (_cat.isNotEmpty)
        _cat = "$_cat\n";
      _cat += _mainModel.category.getCategoryName(item, context);
    }
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                              ...
                              SizedBox(width: 20,),
                              button2small(strings.get(62), (){_openDialogDelete(_mainModel.currentProviderRequest);},
                                  color: dashboardErrorColor.withAlpha(150)), /// "Delete",
                              SizedBox(width: 20,),
                              button2small(strings.get(184), () {  /// "Close",
                                widget.close();
                              }),
                        ],
                      )
