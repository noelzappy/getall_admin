                    ...
                    Column(
                      ...
                      children: [
                            ...
                            Expanded(child: Container(
                                ...
                                child: Combo(inRow: true, text: "",
                                  ...
                                  onChange: (String value){
                                    ...
                                    if (_mainModel.service.editAddon != null)
                                      _controllerName.text = getTextByLocale(_mainModel.service.editAddon!.name, _mainModel.langEditDataComboValue);
                                    _redraw();
                                  },))),
                          ],
                        ),
                        ...
                        Row(children: [
                          ...
                          SizedBox(width: 10,),
                          button2small(_mainModel.service.editAddon == null ? strings.get(348) : strings.get(351), /// "Add addon",  "Save addon",
                              () async {
                            var ret = await _mainModel.service.addAddon(_controllerName.text, toDouble(_controllerPrice.text));
                            if (ret != null)
  ...
  _list(){
    ...
    if (_providerAddons != null)
      for (var item in _providerAddons){
        bool _found = false;
        for (var currentAddon in _mainModel.service.current.addon)
      ...
      children: [
        ...
        Expanded(child: Container(
          ...
          button134(strings.get(68), /// "Edit",
              (){
                _mainModel.service.editAddon = item;
        ...
        Expanded(child: Container(
            ...
            theme.mainColor, theme.style14W400, item.selected,
                (val) {
              if (val == null) return;
              _mainModel.service.selectAddon(item, val);
              ...
              children: [
                ...
                Flexible(child: button2(strings.get(62), /// "Delete",
                    dashboardErrorColor, () async {
                      Navigator.pop(context); // close dialog
                      var ret = await _mainModel.service.deleteAddon(item.id);
                      if (ret != null)
                        return messageError(context, ret);
                      else
